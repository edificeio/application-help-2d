...
Les archives sont **générées automatiquement tous les étés**. En tant qu'enseignant vous disposez de tous vos cahiers de textes des années précédentes au format PDF.

![](<.gitbook/assets/9archives (1).png>)
