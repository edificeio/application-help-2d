...
À l’aide de l’application **Formulaire**, lancez-vous facilement dans la création de formulaires afin de sonder les autres utilisateurs sur différents sujets.
Créez des sondages et des formulaires afin de recueillir l’avis des autres membres de l’ent.
...
4. Vous pouvez télécharger toutes les réponses dans un fichier PDF en cliquant sur **« Télécharger tous les résultats (PDF) »**.

    ![](.gitbook/assets/07_resultats-d-un-formulaire2.png)

5. Pour les dépôts de fichier, il est possible de :
...
![](.gitbook/assets/10_organiser-ses-formulaires-pour-le-repondant1.png)
