...
![](<.gitbook/assets/02\_evaluation-avec-des-competences.jpg>)
...
![](<.gitbook/assets/04\_evaluation-avec-des-competences-3.jpg>)
...
2.  Renseigner **les critères (2)**
    ...
    ![](<.gitbook/assets/06\_evaluer-un-eleve-2 (4).jpg>)
...
3.  Cliquer sur **le devoir à évaluer (3)**
    ...
    ![](<.gitbook/assets/07\_evaluer-un-eleve-4 (5).jpg>)
...
![](<.gitbook/assets/08\_cartouche (1).jpg>)

![](<.gitbook/assets/09\_resultats-devoir (1).jpg>)
...
![](<.gitbook/assets/15\_suivre-le-niveau-des-eleves-1 (12).jpg>)
...
1.  Cliquez sur le menu **« Suivi classe » (1)**
    ...
    ![](<.gitbook/assets/22\_suivi-classe (3).jpg>)
...
5.  En cliquant sur un élève, s’affiche le **suivi de compétence de l’élève (5)**.
    ...
    ![](<.gitbook/assets/24\_suivi-classe-3 (4).jpg>)
