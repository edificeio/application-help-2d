...
![](<.gitbook/assets/01_calendar.png>)
...
![](<.gitbook/assets/02_actions_agenda.png>)
...
![](<.gitbook/assets/03_recurrence.png>)
...
![](<.gitbook/assets/03_ressources.png>)

On sélectionne dans un premier temps l'établissement pour lequel on souhaite réserver la ressource.
Il est alors possible de choisir le **type de ressource** que l'on souhaite réserver, puis la ressource pour laquelle on souhaite effectuer une réservation.
...
**Il n'est pas possible d'effectuer une réservation de ressource pour un évènement s'étalant sur plusieurs jours ou pour une date passée. Il n'est pas encore possible de faire une réservation pour un évènement récurrent (fonctionnalité à venir)**
...
![](<.gitbook/assets/04_partage_droits.png>)
...
![](<.gitbook/assets/06_deselectionner_agenda.png>)
...
![](<.gitbook/assets/06_vue_liste.png>)
